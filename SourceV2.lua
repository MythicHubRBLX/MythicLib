...
local MythicLib = {
	Themes = {
		...
		Claro = {
			["Color Hub 1"] = ColorSequence.new({ColorSequenceKeypoint.new(0.00, Color3.fromRGB(215, 215, 215)), ColorSequenceKeypoint.new(0.50, Color3.fromRGB(208, 208, 208)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(215, 215, 215))}),
			["Color Hub 2"] = Color3.fromRGB(210, 210, 210),
			["Color Stroke"] = Color3.fromRGB(190, 190, 190),
			["Color Theme"] = Color3.fromRGB(65, 150, 255),
			["Color Text"] = Color3.fromRGB(10, 10, 10),
			["Color Dark Text"] = Color3.fromRGB(41, 41, 41)
		},
		Roxo = {
...
function MythicLib:MakeWindow(Configs)
	...
	local WMiniText = Configs[2] or Configs.SubTitle or "por: Equipe Mythic"
	...
	if SaveRejoin and type(SaveRejoin) == "string" then
		SaveRejoin = string.gsub(SaveRejoin, "/", "|")
	end
	...
	function Window:CloseBtn()
		local Dialog = Window:Dialog({
			Title = "Equipe Mythic",
			Text = "Tem Certeza que Deseja Fechar o Menu?",
	...
	function Window:Dialog(Configs)
		...
		local DTitle = Configs[1] or Configs.Title or "Diálogo"
		local DText = Configs[2] or Configs.Text or "Isso é um Diálogo"
	...
	function Window:MakeTab(paste, Configs)
		...
		local TName = Configs[1] or Configs.Title or "Aba"
		...
		function Tab:AddParagraph(Configs)
			local PName = Configs[1] or Configs.Title or "Paragráfo"
		...
		function Tab:AddButton(Configs)
			local BName = Configs[1] or Configs.Name or Configs.Title or "Botão"
		...
		function Tab:AddToggle(Configs)
			local TName = Configs[1] or Configs.Name or Configs.Title or "Alternância"
		...
		function Tab:AddDropdown(Configs)
			local DName = Configs[1] or Configs.Name or Configs.Title or "Lista"
		...
		function Tab:AddMultiDropdown(Configs)
			local DName = Configs[1] or Configs.Name or Configs.Title or "Multi Lista"
			local DDesc = Configs.Desc or Configs.Description or ""
			local DOptions = Configs[2] or Configs.Options or {}
			local DDefault = Configs[3] or Configs.Default or {}
			...
			function UpdateSelectedOptions()
				...
				for _, Option in pairs(ScrollFrame:GetChildren()) do
					if Option:IsA("Frame") and Option.Name == "Option" and Option.BackgroundColor3 == Theme["Color Theme"] then
						table.insert(SelectedOptions, Option.TextLabel.Text)
					end
				end
			end
			...
			function Dropdown:Remove(Option)
				if type(Option) == "string" then
					for _, Child in pairs(ScrollFrame:GetChildren()) do
						if Child:IsA("Frame") and Child.Name == "Option" and Child.TextLabel.Text == Option then
							Child:Destroy()
						end
					end
				elseif type(Option) == "number" then
					local Child = ScrollFrame:GetChildren()[Option]
					if Child and Child:IsA("Frame") and Child.Name == "Option" then
						Child:Destroy()
					end
				end
				UpdateSelectedOptions()
			...
			function Dropdown:GetCallback()
				return Callback
			end

			function Dropdown:GetMultCallback()
				return MultCallback
			end
		...
		function Tab:AddSlider(Configs)
			local SName = Configs[1] or Configs.Name or Configs.Title or "Deslizador"
		...
		function Tab:AddTextBox(Configs)
			local TName = Configs[1] or Configs.Name or Configs.Title or "Caixa de Texto"
			local TDesc = Configs.Desc or Configs.Description or ""
